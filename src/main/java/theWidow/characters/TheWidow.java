...
import static theWidow.WidowMod.*;
import static theWidow.characters.TheWidow.Enums.COLOR_BLACK;
...
public class TheWidow extends CustomPlayer {
    ...
    public static class Enums {
        ...
        @SpireEnum(name = "WIDOW_BLACK_COLOR") // These two HAVE to have the same absolutely identical name.
        public static AbstractCard.CardColor COLOR_BLACK;
        @SpireEnum(name = "WIDOW_BLACK_COLOR") @SuppressWarnings("unused")
    ...
    public TheWidow(String name, PlayerClass setClass) {
        super(name, setClass, orbTextures,
                ...
                new SpineAnimation(THE_WIDOW_SKELETON_ATLAS, THE_WIDOW_SKELETON_JSON, 1f));
        ...
        loadAnimation(
                THE_WIDOW_SKELETON_ATLAS,
                THE_WIDOW_SKELETON_JSON,
                1.0f);
