...
public class GrenadePlusPotion extends CustomPotion {

    public static final String POTION_ID = WidowMod.makeID(GrenadePlusPotion.class.getSimpleName());
