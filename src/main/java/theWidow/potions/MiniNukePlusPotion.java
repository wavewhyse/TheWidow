...
public class MiniNukePlusPotion extends CustomPotion {

    public static final String POTION_ID = WidowMod.makeID(MiniNukePlusPotion.class.getSimpleName());
