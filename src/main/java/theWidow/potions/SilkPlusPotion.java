...
public class SilkPlusPotion extends CustomPotion {

    public static final String POTION_ID = WidowMod.makeID(SilkPlusPotion.class.getSimpleName());
