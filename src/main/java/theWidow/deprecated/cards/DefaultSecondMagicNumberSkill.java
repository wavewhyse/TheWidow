...
public class DefaultSecondMagicNumberSkill extends AbstractDynamicCard {
     ...
     * variables.secondMagicNumber and cards.ExtraMagicalCustomCard
     *
    ...
    public static final String ID = WidowMod.makeID(DefaultSecondMagicNumberSkill.class.getSimpleName());
