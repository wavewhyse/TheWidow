...
// Skip this question until you start figuring out the ExtraMagicalCustomCard/AbstractDynamicCard and just extend DynamicCard
...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = WidowMod.makeID(DefaultCommonAttack.class.getSimpleName());
