...
public class ImprobabilityDrive2 extends BetaCard {

    // TEXT DECLARATION

    public static final String ID = WidowMod.makeID(ImprobabilityDrive2.class.getSimpleName());
